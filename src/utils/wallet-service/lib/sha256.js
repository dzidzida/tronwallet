...
(function(I) {
  ...
  function D(c, a, d) {
    ...
    for (b = 0; b < a; b += 1) {
      (g = c[b >>> 2] >>> (8 * (3 + (b % 4) * -1))),
        (l += '0123456789abcdef'.charAt((g >>> 4) & 15) + '0123456789abcdef'.charAt(g & 15));
    }
      ...
      case 'TEXT':
        d = function(c, b, d) {
          ...
          if ('UTF8' === a) {
            ...
            for (
              r = 2, n = ('UTF16LE' === a && !0) || ('UTF16LE' !== a && !1), e = 0;
              e < c.length;
              e += 1
            ) {
              f = c.charCodeAt(e);
  ...
  function Q(c, a, d, l) {
    ...
    return (
      ((((c >>> 16) + (a >>> 16) + (d >>> 16) + (l >>> 16) + (b >>> 16)) & 65535) << 16) |
      (b & 65535)
    );
  }
  ...
  function R(c, a, d, l, b) {
    ...
    return (
      ((((c >>> 16) + (a >>> 16) + (d >>> 16) + (l >>> 16) + (b >>> 16) + (g >>> 16)) & 65535) <<
        16) |
      (g & 65535)
    );
  }
