...
(function(Y) {
  function C(c, a, b) {
    ...
    this.getHash = function(a, b) {
      ...
      for (g = 1; g < t; g += 1) {
        !0 === z && 0 !== f % 32 && (m[m.length - 1] &= 16777215 >>> (24 - f % 32)),
          (m = u(m, f, 0, A(c), f));
      }
      return k(m);
    };
  ...
  function O(c, a, b, e) {
    ...
    for (n = 0; n < a; n += 1) {
      (g = c[n >>> 2] >>> (8 * (d + (n % 4) * b))),
        (h += '0123456789abcdef'.charAt((g >>> 4) & 15) + '0123456789abcdef'.charAt(g & 15));
    }
                  ...
                  128 > g
                    ...
                    : 2048 > g
                      ...
                      : 55296 > g || 57344 <= g
                        ...
                        : ((f += 1),
                          (g = 65536 + (((g & 1023) << 10) | (c.charCodeAt(f) & 1023))),
                          l.push(
                            240 | (g >>> 18),
                            128 | ((g >>> 12) & 63),
                            128 | ((g >>> 6) & 63),
  ...
  function S(c, a) {
    return 32 < a
      ...
      : 0 !== a ? new b((c.a << a) | (c.b >>> (32 - a)), (c.b << a) | (c.a >>> (32 - a))) : c;
  }
  ...
  function la(c, a, b, e) {
    ...
    return (
      ((((c >>> 16) + (a >>> 16) + (b >>> 16) + (e >>> 16) + (h >>> 16)) & 65535) << 16) |
      (h & 65535)
    );
  }
  ...
  function H(c, a, b, e, h) {
    ...
    return (
      ((((c >>> 16) + (a >>> 16) + (b >>> 16) + (e >>> 16) + (h >>> 16) + (d >>> 16)) & 65535) <<
        16) |
      (d & 65535)
    );
  }
